...
string[] startArray = FillArray("Введите текст, чтобы заполнить элемент массив. Для окончания ввода элемента массива нажмите 'Enter'. Для завершения заполнения массива нажмите 'Ctrl + z'. -> ");
